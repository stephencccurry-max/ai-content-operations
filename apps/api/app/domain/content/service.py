...
def _get_or_create_slot(
    ...
    task_platform = _require_task_platform(session, task_id, platform)
    slot = session.scalar(
...
def generate_output(
    ...
    _require_task_platform(session, task_id, platform)
